            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="../img/a0.jpg"/></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="goods_type_list.html">商品分类</a>
                        </li>
                        <li><a class="J_menuItem" href="goods_list.html">商品编辑</a>
                        </li>
                        <li><a class="J_menuItem" href="#">商品上下架</a>
                        </li>
