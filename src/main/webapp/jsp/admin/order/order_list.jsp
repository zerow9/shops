...
<head>
    ...
    <link rel="stylesheet" href="../../../shopmanagement/common/layui/css/layui.css" media="all">
</head>
<body>
...
<table class="layui-table" lay-data="{url:'/data/order_lists.json', page:true, id:'idTest'}"
       lay-filter="demo">
    <thead>
    <tr>
...
<script src="../../../shopmanagement/common/layui/layui.js" charset="utf-8"></script>
<script>
