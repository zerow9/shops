    ...
    table.on('tool(demo)', function (obj) {
        ...
        if (obj.event === 'detail') {
            layer.open({
                ...
                shadeClose: true,
                shade: 0.3,
                content: 'seeRepertoryIdByKey.action?adminId='+data.repertoryId, //注意，如果str是object，那么需要字符拼接。
                maxmin: true,
                area: ['80%', '90%']
            });
            ...
            swal({
                ...
                //通 ajax 加载方法
                $.post('deleteRepertoryByPrimaryKey.action', {'repertoryId': data.repertoryId}, function (index) {
            ...
            layer.open({
                ...
                maxmin: true,
                area: ['80%', '90%'],
                content: 'updateRepertory.action?id=' + data.repertoryId, //注意，如果str是object，那么需要字符拼接。
            });
        }
    });
        ...
        active = {
            ...
            addRepertory: function () {
                layer.open({
                    ...
                    maxmin: true,
                    area: ['80%', '90%'],
                    content: 'addRepertory.action', //注意，如果str是object，那么需要字符拼接。
                });
            }
        };
